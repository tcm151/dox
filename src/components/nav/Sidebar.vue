<template>
    <div class="box content">
        ...
        <ol class="mx-4">
            ...
            <li class="my-1">Mark things as misleading when the information given is intented to might guide someone in
                the wrong direction, or stray away from the original topic of discussion.</li>
